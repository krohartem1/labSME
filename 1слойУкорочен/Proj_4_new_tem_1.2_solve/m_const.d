...
// Material constants for steel and TiNi elemens
 ...
 SY2 = 2000 //1200yield limit for steel in MPa
  ...
  r_l = 0.8//0.7 //0.95 //3.7 //3.7 //0.7 // length difference in mm (То, на сколько укорочено наружное волокно)
  l_n = 124.0 // length of plate in mm (2*Pi*r)
  rad = 20 // radius in mm (Радиус кривизны композита)
